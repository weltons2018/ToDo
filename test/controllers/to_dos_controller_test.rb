...
class ToDosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create to_do" do
    assert_difference("ToDo.count") do
      post to_dos_url, params: { to_do: { completed: @to_do.completed, deadline: @to_do.deadline, description: @to_do.description, name: @to_do.name } }
    end
  ...
  test "should update to_do" do
    patch to_do_url(@to_do), params: { to_do: { completed: @to_do.completed, deadline: @to_do.deadline, description: @to_do.description, name: @to_do.name } }
